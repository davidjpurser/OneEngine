	...
	class AQ_Block {
	 	...
	 	*/
	 	...
	 	function block($instance) {
	 		extract($instance);
	 		echo __('function AQ_Block::block should not be accessed directly. Output generated by the ', 'oneengine') . strtoupper($id_base). ' Class';
	 	}
	 	...
	 	function form($instance) {
	 		echo '<p class="no-options-block">' . __('There are no options for this block.', 'oneengine') . '</p>';
	 		return 'noform';
	 	}
	 	...
	 	function before_block($instance) {
	 		...
	 		echo '<div id="aq-block-'.$template_id.'-'.$number.'" class="aq-block aq-block-'.$id_base.' '.$size.'">';
			if($id_base == 'aq_column_block') echo '<div class="row">';
	 	}
	 	
	 	/* block footer */
	 	function after_block($instance) {
	 		extract($instance);
			if($id_base == 'aq_column_block') echo '</div>';
	 		echo '</div>';	
	 	}
